...
func GerarInfoFichaSpecific(racaEscolhida, classeEscolhida string, idadeEscolhida int) (*DataChar.Personagem, *Sheet.Coordenadas, []string, string, string, string, string, error) {
	...
	// Gerar personagem personalizado
	personagem, err := GerarPersonagemCustomizado(racaEscolhida, classeEscolhida, idadeEscolhida, racas, classes, status, &talentos, atributosData, pontosXP, &equipamentos)
	if err != nil {
